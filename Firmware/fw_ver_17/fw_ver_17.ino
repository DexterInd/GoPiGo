...
#include <IRLibRecv.h>
IRrecv myReceiver(10);  //pin number for the receiver
                        // Goes on the digital port marked D11.
...
void loop()
{
    ...
    if (myReceiver.getResults()) {
      ...
      unsigned long ir_value = myDecoder.value;
      if((ir_value != 0xFFFFFFFF) && (ir_value != 0x00000000)){
    ...
    if(cmd[0]==ir_last_value){
      //payload[0] = (last_ir_value & 0xff000000UL) >> 24;
      //payload[1] = (last_ir_value & 0x00ff0000UL) >> 16;
      //payload[2] = (last_ir_value & 0x0000ff00UL) >>  8;
      payload[0] = (last_ir_value & 0x000000ffUL)      ;
      payload[1] = (0);
